  ...
  return (
    <div className="App">
      ...
      <section className='bgImage' id='home'>
        <div className='bgGradient text-center'>
        ...
        <div className='container text-left  '>
          <div className='row '>
            <div className='col-md-6 col-12  mt-5 text-left'>
              ...
              <button className=" mb-2 btn btn-danger rounded mt-3  px-4 py-2 " type="submit">Learn More<i class="fa-solid fa-arrow-right ms-3 mt-1"></i></button>
      ...
      <section className="bgDisc mt-5">
        <div className="bg-Gradient text-center text-white">
          ...
          <div className="row">
            <div className="col-md-4 col-12">
              <div className="text-center border rounded shadow-lg mt-5">
                ...
                <button className='mt-3 btn btn-danger mb-2'>Join Now</button>
              </div>
            </div>
            <div className="col-md-4 col-12">
              <div className="text-center border rounded shadow-lg mt-5">
          ...
          <div className="row">
            <div className="col-12">
              <div className="text-center">
                <button className=' mb-5 btn btn-danger rounded mt-5  px-4 py-2'>Get Started<i class="fa-solid fa-arrow-right ms-3 mt-1"></i> </button>
              </div>
            </div>
          </div>
        </div>
...
<section className='bg-light mt-5'>
  <div className="container">
     <div className="row mt-5">
      <div className="col-md-6 col-12">
      <i class="fa-brands fa-facebook iconsFooter mx-2 p-3 my-5 h4Blog"></i>
      <i class="fa-brands fa-twitter iconsFooter mx-2 p-3 my-5 h4Blog"></i>
      <i class="fa-brands fa-linkedin iconsFooter mx-2 p-3 my-5 h4Blog"></i>
      <i class="fa-brands fa-google-plus-g iconsFooter mx-2 p-3 my-5 h4Blog"></i>
      </div>
      <div className="col-md-3 col-12">
      <p><i class="fa-solid fa-phone my-5 phoneicon p-3"></i>+91 123 4556 789</p>
      </div>
      <div className="col-md-3 col-12">
      <p><i class="fa-regular fa-envelope-open phoneicon p-3 my-5"></i>adilharoon304@gamil.com</p>
      </div>
     </div>
  </div>
</section>
<section className="bg-dark">
  <div className="container">
    <div className="row">
      ...
      <input type="email" name="" id="" placeholder='Email' style={{backgroundColor:"#2e313a",border:"none",}} className='rounded p-2 w-100'/>
      </div>
    </div>
  </div>
</section>
<footer style={{backgroundColor:"#2e313a",}}>
  <div className="container">
    <div className="row">
